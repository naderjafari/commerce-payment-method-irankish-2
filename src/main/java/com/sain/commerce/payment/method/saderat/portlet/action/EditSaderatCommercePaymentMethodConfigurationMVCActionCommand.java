...
package com.sain.commerce.payment.method.saderat.portlet.action;
...
@Component(
	...
	property = {
		...
		"mvc.command.name=editSaderatCommercePaymentMethodConfigurationMVCActionCommand"
	},
	service = MVCActionCommand.class
)
public class EditSaderatCommercePaymentMethodConfigurationMVCActionCommand
		...
		Settings settings = _settingsFactory.getSettings(
			new GroupServiceSettingsLocator(
				themeDisplay.getScopeGroupId(),
					SaderatBankCommercePaymentMethodConstants.SERVICE_NAME));
