 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "https://ikc.shaparak.ir/TToken/Tokens.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://ikc.shaparak.ir/TToken/Tokens.xml");
     ...
     *     returns ITokens
     */
    @WebEndpoint(name = "BasicHttpBinding_ITokens")
    public ITokens getBasicHttpBindingITokens() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ITokens"), ITokens.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_ITokens")
    public ITokens getBasicHttpBindingITokens(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ITokens"), ITokens.class, features);
    }
